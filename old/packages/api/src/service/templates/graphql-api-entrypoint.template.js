...
exports.graphqlApiEntrypointTemplate = void 0;
const graphqlApiEntrypointTemplate = () => /* ts*/ `import { GraphQLAPI } from '@saws/api/graphql-api';
...
`;
exports.graphqlApiEntrypointTemplate = graphqlApiEntrypointTemplate;
