...
const getTemplate = ({ name, moduleName, codeBucketName, codeS3Key, stage, permissions, userPoolClientId, userPoolId, environment, }) => {
    const config = {
        ...
        Resources: {
            ...
            SawsApiLambdaRole: {
                Type: "AWS::IAM::Role",
                Properties: {
                    RoleName: `SawsApi${(0, uppercase_1.uppercase)(name)}${(0, uppercase_1.uppercase)(stage)}LambdaRole`,
                    ...
                    Policies: [
                        {
                            PolicyName: `AWSLambda${(0, uppercase_1.uppercase)(name)}${(0, uppercase_1.uppercase)(stage)}BasicExecutionRole`,
                            PolicyDocument: {
                                Version: "2012-10-17",
                                Statement: [
                                    {
