...
const Login = ({ sessionClient, isShowing, onRequiresConfirmation, onRequiresNewPassword, onRequiresResetPassword, }) => {
        ...
        <react_1.Box borderWidth="1px" borderRadius="lg" p="6" mt="3">
          <form onSubmit={login}>
            <react_1.FormControl mb="3">
              ...
              <react_1.Input type="email" width="400px" required value={email} onChange={(e) => setEmail(e.currentTarget.value)}/>
            </react_1.FormControl>
            <react_1.FormControl mb="6">
              <react_1.FormLabel>Password</react_1.FormLabel>
              <react_1.Input type="password" width="400px" required value={password} onChange={(e) => setPassword(e.currentTarget.value)}/>
            </react_1.FormControl>
