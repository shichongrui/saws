...
const Confirm = ({ email, isShowing, sessionClient }) => {
    ...
    return (<react_1.Fade in={isShowing}>
      <react_1.Box>
        <react_1.Heading>Confirm your email</react_1.Heading>
        <react_1.Text>Check your email for a confirmation code</react_1.Text>
        <react_1.Box borderWidth="1px" borderRadius="lg" p="6" mt="3">
          <form onSubmit={register}>
            <react_1.FormControl mb="3">
              <react_1.FormLabel>Code</react_1.FormLabel>
              <react_1.Input width="400px" required value={code} onChange={(e) => setCode(e.currentTarget.value)} isInvalid={fieldErrors.code != null}/>
