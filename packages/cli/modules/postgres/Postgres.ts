import { ModuleType, PostgresConfig, ServiceType } from "../../../config";
...
export class Postgres implements ModuleDefinition, PostgresConfig {
  ...
  async getEnvironmentVariables() {
    return {
      ...
      DATABASE_URL: `postgres://${this.outputs.postgresUsername}:${await getDBPassword()}@${this.outputs.postgresHost}:${this.outputs.postgresPort}/${this.outputs.postgresDBName}`
    };
  }
