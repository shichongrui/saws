...
import { BUILD_DIR, ModuleType, WebsiteConfig } from "@shichongrui/saws-core";
import { CloudFormation, S3, Cloudfront } from "@shichongrui/saws-aws";
...
export class Website implements ModuleDefinition, WebsiteConfig {
  ...
  async writeEnvVarFile(stage: string, nodeEnv: "development" | "production") {
    const environmentVariables = this.config.env ?? {};
